...
function sumUpdate() {
    ...
    result = calculate($("table.book-list"));
    $(".book-num").text(result[0]);
    $(".book-sum-price").text(result[1]);
    //如果没选满
    if (result[0] === 0) {
...
$(function () {
    sumUpdate();
    $("table.book-list tbody .select-img").click(function () {
    ...
    $(".select-all").click(function () {
        if ($(this).attr("select") === "false") {
            ...
            $("table.book-list tbody tr").each(function () {
                //先全不选
