...
<main class="cart">
    <form action="buy">
        ...
        <table class="cart-list" id="table-id">
            ...
            <tbody>
            <input id="ciid-id" type="hidden" name="ciid" value="">
            <c:forEach items="${cartItems}" var="item">
                <tr class="test" select="false" stock="${item.product.stock}" buy="${item.number}"
                    price-per="${item.product.nowPrice}" ciid="${item.id}">
                        <%--                <input class="ciid-class" type="hidden" name="ciid" value="${item.id}">--%>
                    <input class="ciid-class" type="hidden"  value="${item.id}">
                    <td>
                    ...
                    <td>
                        <div class="cart-change">
                            <a href="javascript:void(0);" class="cart-decrease cart-change-button">-</a><input
                                value="${item.number}" class="item-num-input"><a href="javascript:void(0);"
        ...
        <div class="sum-bottom  clear">
            ...
            <span>
                ...
                <button class="crate-order-big crate-order" type="submit" id="summitConfirm">去结算</button>
            </div>
        </div>
    </form>
